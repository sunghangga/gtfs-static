...
public class Stopplaceowner {
    ...
    public Stopplaceowner withValidfrom(ZonedDateTime value) {
        setValidfrom(value);
        return this;
    }

    public Stopplaceowner withStopplaceownercode(String value) {
        setStopplaceownercode(value);
        return this;
    }

    public Stopplaceowner withMutationdate(ZonedDateTime value) {
