...
public class Quaytypedata {
    ...
    public Quaytypedata withValidfrom(ZonedDateTime value) {
        setValidfrom(value);
        return this;
    }

    public Quaytypedata withQuaytype(String value) {
        setQuaytype(value);
        return this;
    }

    public Quaytypedata withMutationdate(ZonedDateTime value) {
