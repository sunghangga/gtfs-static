...
public class Quaydisabledaccessible {
    ...
    public Quaydisabledaccessible withValidfrom(ZonedDateTime value) {
        setValidfrom(value);
        return this;
    }

    public Quaydisabledaccessible withTransportmode(String value) {
        setTransportmode(value);
        return this;
    }

    public Quaydisabledaccessible withDisabledaccessible(String value) {
        setDisabledaccessible(value);
        return this;
    }

    public Quaydisabledaccessible withStepFreeAccess(LimitationStatusEnum value) {
        setStepFreeAccess(value);
        return this;
    }

    public Quaydisabledaccessible withWheelchairAccess(LimitationStatusEnum value) {
        setWheelchairAccess(value);
        return this;
    }

    public Quaydisabledaccessible withMutationdate(ZonedDateTime value) {
