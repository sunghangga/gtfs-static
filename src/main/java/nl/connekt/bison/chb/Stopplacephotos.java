...
public class Stopplacephotos {
    ...
    public Stopplacephotos withStopplacephotodata(Stopplacephotodata... values) {
        if (values!= null) {
            for (Stopplacephotodata value: values) {
                getStopplacephotodata().add(value);
            }
        }
        return this;
    }

    public Stopplacephotos withStopplacephotodata(Collection<Stopplacephotodata> values) {
        if (values!= null) {
            getStopplacephotodata().addAll(values);
        }
        return this;
    }
