...
public class Quaylocationdata {
    ...
    public Quaylocationdata withValidfrom(ZonedDateTime value) {
        setValidfrom(value);
        return this;
    }

    public Quaylocationdata withRdX(int value) {
        setRdX(value);
        return this;
    }

    public Quaylocationdata withRdY(int value) {
        setRdY(value);
        return this;
    }

    public Quaylocationdata withTown(String value) {
        setTown(value);
        return this;
    }

    public Quaylocationdata withLevel(String value) {
        setLevel(value);
        return this;
    }

    public Quaylocationdata withMutationdate(ZonedDateTime value) {
        setMutationdate(value);
        return this;
    }

    public Quaylocationdata withRdZ(Integer value) {
        setRdZ(value);
        return this;
    }

    public Quaylocationdata withStreet(String value) {
        setStreet(value);
        return this;
    }

    public Quaylocationdata withLocation(String value) {
        setLocation(value);
        return this;
    }
