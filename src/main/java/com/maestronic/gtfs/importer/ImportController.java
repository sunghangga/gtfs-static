...
public class ImportController {
    ...
    @Autowired
    private ImportInitialize importInitialize;
    @Autowired
    ...
    public ResponseEntity<Object> importGtfs(@RequestParam(required = true) MultipartFile file,
        ...
        if (!fileType.equals("application/zip")) {
            return new ResponseEntity<>(
                    ResponseMessage.exceptionErrorJson(
                            HttpStatus.BAD_REQUEST.value(),
                            "File with " + fileType + " extension is not supported! Please upload file with zip extension."
                    ),
                    HttpStatus.BAD_REQUEST
            );
        }
        ...
        Import response = importInitialize.initializeImport(task_name, file, GlobalVariable.GTFS_FILE_TYPE,
                releaseDate);
        return new ResponseEntity<>(
    ...
    public ResponseEntity<Object> importChb(@RequestParam(required = true) MultipartFile file,
        ...
        if (!fileType.equals("application/gzip")) {
            return new ResponseEntity<>(
                    ResponseMessage.exceptionErrorJson(
                            HttpStatus.BAD_REQUEST.value(),
                            "File with " + fileType + " extension is not supported! Please upload file with zip, gzip extension."
                    ),
                    HttpStatus.BAD_REQUEST
            );
        }
        ...
        Import response = importInitialize.initializeImport(task_name, file, GlobalVariable.CHB_FILE_TYPE,
                releaseDate);
        return new ResponseEntity<>(
                ResponseMessage.retrieveDataJson(
                        HttpStatus.OK.value(),
    ...
    public ResponseEntity<Object> importPsa(@RequestParam(required = true) MultipartFile file,
        ...
        Import response = importInitialize.initializeImport(task_name, file, GlobalVariable.PSA_FILE_TYPE,
                releaseDate);
        return new ResponseEntity<>(
                ResponseMessage.retrieveDataJson(
                        HttpStatus.OK.value(),
